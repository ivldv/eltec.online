...
require_once __DIR__."/PhPExcel-1.8/Classes/PHPExcel/IOFactory.php"; // подключаем класс для доступа к файлу
echo ' Подключился ,';
...
$objPHPExcel = PHPExcel_IOFactory::load(__DIR__."/uploads/".$loadfile);
