<?php
//echo ($_SERVER['DOCUMENT_ROOT'].'/SE/model/elevel.php');
...
echo ' Подключился ,';
function loadRealStock($url,$table)
{
    $loadfile = 'real.zip';
...
loadRealStock('http://www.realelectro.com/stock/Stock_ABB.zip',$table);
loadRealStock('http://www.realelectro.com/stock/Stock_Legrand.zip',$table);
loadRealStock('http://www.realelectro.com/stock/Stock_BT.zip',$table);
loadRealStock('http://www.realelectro.com/stock/Stock_SE.zip',$table);
loadRealStock('http://www.realelectro.com/stock/Stock_Devi.zip',$table);
loadRealStock('http://www.realelectro.com/stock/Stock_Gira.zip',$table);
loadRealStock('http://www.realelectro.com/stock/Stock_Jung.zip',$table);
loadRealStock('http://www.realelectro.com/stock/Stock_Merten.zip',$table);
